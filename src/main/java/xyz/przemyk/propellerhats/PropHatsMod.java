...
public class PropHatsMod {
    ...
    public static final RegistryObject<PropellerHatItem> IRON_HAT = ITEMS.register("iron_hat", () -> new PropellerHatItem(ArmorMaterials.IRON, new Item.Properties().stacksTo(1), 70_000, 30, 0.1f));
    public static final RegistryObject<PropellerHatItem> GOLDEN_HAT = ITEMS.register("golden_hat", () -> new PropellerHatItem(ArmorMaterials.GOLD, new Item.Properties().stacksTo(1), 100_000, 40, 0.16f));
    public static final RegistryObject<PropellerHatItem> DIAMOND_HAT = ITEMS.register("diamond_hat", () -> new PropellerHatItem(ArmorMaterials.DIAMOND, new Item.Properties().stacksTo(1), 500_000, 150, 0.22f));
    public static final RegistryObject<PropellerHatItem> NETHERITE_HAT = ITEMS.register("netherite_hat", () -> new PropellerHatItem(ArmorMaterials.NETHERITE, new Item.Properties().stacksTo(1), 1_000_000, 250, 0.3f));
    public static final RegistryObject<PropellerHatItem> CREATIVE_HAT = ITEMS.register("creative_hat", () -> new PropellerHatItem(ArmorMaterials.NETHERITE, new Item.Properties().stacksTo(1), 1, 0, 0.3f) {
        @Override
    ...
    public static void addHatsToCreativeTab(BuildCreativeModeTabContentsEvent event) {
        if (event.getTabKey() == CreativeModeTabs.TOOLS_AND_UTILITIES) {
            event.accept(IRON_HAT);
            event.accept(GOLDEN_HAT);
            event.accept(DIAMOND_HAT);
            event.accept(NETHERITE_HAT);
            event.accept(CREATIVE_HAT);
        }
    }

    public static final RegistryObject<SoundEvent> PROPELLER_SOUND_EVENT = SOUND_EVENTS.register("propeller", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(MODID, "propeller")));
